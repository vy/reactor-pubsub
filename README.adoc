...
- `ScheduledExecutorService` for scheduling access token refreshes
- `Scheduler` for scheduling delays in `PubsubSubscriber` _(optional)_
- `PubsubAccessTokenCache` for authenticating HTTP requests
- `MeterRegistry` for metrics _(optional)_
- `PubsubClient` for Pub/Sub HTTP requests

```java
// Create an executor for scheduling access token refreshes.
...
// Create a scheduler for delays in the subscriber. (optional)
...
// Create a meter registry for client metrics. (optional)
...
PubsubClient client = PubsubClient
        ...
        .setMeterRegistry(meterRegistry)    // optional
        .build();
```
...
PubsubSubscriber subscriber = PubsubSubscriber
        ...
        .setScheduler(scheduler)    // optional
        .build();
