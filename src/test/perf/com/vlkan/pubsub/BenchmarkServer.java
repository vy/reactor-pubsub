...
public class BenchmarkServer implements Callable<Integer> {
    ...
    private static List<byte[]> createPullResponsePayloads(
        ...
        return pullResponses
                .stream()
                .map(BenchmarkServer::jsonSerialize)
                .collect(Collectors.toList());
    }
    ...
    public static void main(String[] args) {
        ...
        BenchmarkServer server = new BenchmarkServer(host, port, distinctResponseCount, messageCount, payloadLength);
